...
/*
  ...
  MODIFIES: nothing
*/
int sumOfEvenGrandparents(const Node* root) {
  // TODO: COMPLETE YOUR IMPLEMENTATION 
  // Feel free to add helper functions as needed. Do not alter the definition of Node.

  return 0; // this line is included in the starter code for compilation purposes. feel free to remove it!
}
